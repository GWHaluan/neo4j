...
A quick glance at the complete graph
...
This section is arguably a bit off-topic.
It contains some notes on the execution of the project and what difficulties i faced while doing it.
...
From proof of concept to Python script and valid CSV
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
